#!/usr/bin/env bash
# Bond Pricing, Duration & Convexity — one-click runner for Linux.
# Double-click this file (or run: bash run-linux.sh). It installs uv (which
# installs Python + the libraries) and runs the project. Figures are saved into
# this same folder.
...
echo "=================================================="
echo "  Bond Pricing, Duration & Convexity project"
echo "=================================================="
