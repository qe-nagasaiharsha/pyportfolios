#!/usr/bin/env bash
# Bond Pricing, Duration & Convexity — one-click runner for macOS.
# Double-click this file. It installs uv (which installs Python + the libraries)
# and runs the project. Figures are saved into this same folder.
