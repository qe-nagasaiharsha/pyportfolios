...
export const PAPERS: Paper[] = [
  { year: 1952, authors: "Harry Markowitz", title: "Portfolio Selection", journal: "The Journal of Finance", note: "Mean–variance optimisation — the birth of modern portfolio theory.", category: "Portfolio Optimization & Asset Allocation" },
  { year: 1958, authors: "James Tobin", title: "Liquidity Preference as Behavior Towards Risk", journal: "Review of Economic Studies", note: "The two-fund separation theorem.", category: "Portfolio Optimization & Asset Allocation" },
  { year: 1964, authors: "William F. Sharpe", title: "Capital Asset Prices", journal: "The Journal of Finance", note: "The CAPM — risk priced by a single market beta.", category: "Portfolio Optimization & Asset Allocation" },
  { year: 1970, authors: "Eugene F. Fama", title: "Efficient Capital Markets: A Review of Theory and Empirical Work", journal: "The Journal of Finance", note: "The efficient-market hypothesis, formalised.", category: "Foundations" },
  { year: 1973, authors: "Fischer Black & Myron Scholes", title: "The Pricing of Options and Corporate Liabilities", journal: "Journal of Political Economy", note: "The option-pricing formula — replication and no-arbitrage.", article: "black-scholes-from-first-principles", category: "Derivatives, Options & Volatility" },
  ...
  { year: 1976, authors: "Stephen A. Ross", title: "The Arbitrage Theory of Capital Asset Pricing", journal: "Journal of Economic Theory", note: "APT — multi-factor returns from no-arbitrage.", category: "Portfolio Optimization & Asset Allocation" },
  { year: 1979, authors: "Cox, Ross & Rubinstein", title: "Option Pricing: A Simplified Approach", journal: "Journal of Financial Economics", note: "The binomial tree — pricing options by backward induction.", category: "Derivatives, Options & Volatility" },
  { year: 1982, authors: "Robert F. Engle", title: "Autoregressive Conditional Heteroscedasticity", journal: "Econometrica", note: "ARCH — modelling time-varying volatility (a Nobel idea).", category: "Risk Management" },
  { year: 1985, authors: "Albert S. Kyle", title: "Continuous Auctions and Insider Trading", journal: "Econometrica", note: "The foundational model of market microstructure and price impact.", category: "Market Microstructure & Execution" },
  { year: 1986, authors: "Tim Bollerslev", title: "Generalized Autoregressive Conditional Heteroscedasticity", journal: "Journal of Econometrics", note: "GARCH — the workhorse volatility model.", article: "evt-t-copula-var", category: "Risk Management" },
  { year: 1992, authors: "Fischer Black & Robert Litterman", title: "Global Portfolio Optimization", journal: "Financial Analysts Journal", note: "Blending market equilibrium with investor views — Black–Litterman.", category: "Portfolio Optimization & Asset Allocation" },
  { year: 1993, authors: "Eugene F. Fama & Kenneth R. French", title: "Common Risk Factors in the Returns on Stocks and Bonds", journal: "Journal of Financial Economics", note: "The three-factor model — size and value beyond the market.", category: "Portfolio Optimization & Asset Allocation" },
  { year: 1993, authors: "Narasimhan Jegadeesh & Sheridan Titman", title: "Returns to Buying Winners and Selling Losers", journal: "The Journal of Finance", note: "Momentum — the most documented anomaly in finance.", article: "cross-sectional-momentum", category: "Algorithmic Trading & Machine Learning" },
  { year: 1993, authors: "Steven L. Heston", title: "A Closed-Form Solution for Options with Stochastic Volatility", journal: "Review of Financial Studies", note: "The Heston model — volatility that is itself random.", category: "Derivatives, Options & Volatility" },
  { year: 1997, authors: "Mark M. Carhart", title: "On Persistence in Mutual Fund Performance", journal: "The Journal of Finance", note: "Adds momentum as a fourth pricing factor.", category: "Portfolio Optimization & Asset Allocation" },
  { year: 2000, authors: "Alexander J. McNeil & Rüdiger Frey", title: "Estimation of Tail-Related Risk Measures for Heteroscedastic Financial Time Series", journal: "Journal of Empirical Finance", note: "GARCH + Extreme Value Theory — conditional tail risk.", article: "evt-t-copula-var", category: "Risk Management" },
  ...
  { year: 2004, authors: "Olivier Ledoit & Michael Wolf", title: "Honey, I Shrunk the Sample Covariance Matrix", journal: "Journal of Portfolio Management", note: "Shrinkage — a well-conditioned covariance that survives out-of-sample.", article: "ledoit-wolf-shrinkage", category: "Portfolio Optimization & Asset Allocation" },
  { year: 2015, authors: "Eugene F. Fama & Kenneth R. French", title: "A Five-Factor Asset Pricing Model", journal: "Journal of Financial Economics", note: "Adds profitability and investment to the factor zoo.", category: "Portfolio Optimization & Asset Allocation" },
  { year: 2016, authors: "Marcos López de Prado", title: "Building Diversified Portfolios that Outperform Out of Sample", journal: "Journal of Portfolio Management", note: "Hierarchical Risk Parity — allocation without inverting a covariance matrix.", article: "hierarchical-risk-parity", category: "Algorithmic Trading & Machine Learning" },
];
