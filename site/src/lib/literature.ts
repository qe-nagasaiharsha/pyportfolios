...
export const PAPERS: Paper[] = [
  ...
  { year: 1973, authors: "Robert C. Merton", title: "Theory of Rational Option Pricing", journal: "Bell Journal of Economics", note: "Extends and generalises Black–Scholes.", category: "Derivatives, Options & Volatility" },
  ...
  { year: 2001, authors: "Robert Almgren & Neil Chriss", title: "Optimal Execution of Portfolio Transactions", journal: "Journal of Risk", note: "The cost–risk frontier of trading — foundational for execution.", category: "Market Microstructure & Execution" },
