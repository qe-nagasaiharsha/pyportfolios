/* ============================================================================
   ...
   Papers that map onto our research articles carry an `article` slug so the
   library cross-links into the case studies.
   ========================================================================== */
...
export const BOOK_GROUPS: BookGroup[] = [
  {
    ...
    books: [
      { title: "Capital Ideas", author: "Peter L. Bernstein", year: 1992, note: "How modern finance theory was actually built, person by person." },
      { title: "Against the Gods: The Remarkable Story of Risk", author: "Peter L. Bernstein", year: 1996, note: "The long history of how humanity learned to measure risk." },
      { title: "A Random Walk Down Wall Street", author: "Burton G. Malkiel", year: 1973, note: "The efficient-markets case for humility and indexing." },
      { title: "Fooled by Randomness", author: "Nassim Nicholas Taleb", year: 2001, note: "On luck, noise, and mistaking one for the other." },
      { title: "The (Mis)Behavior of Markets", author: "Benoit Mandelbrot & Richard Hudson", year: 2004, note: "Fat tails and fractals — why returns are wilder than the bell curve." },
      { title: "A Man for All Markets", author: "Edward O. Thorp", year: 2017, note: "The original quant, from blackjack to the first market-neutral fund." },
    ],
  },
  {
    ...
    books: [
      { title: "Options, Futures, and Other Derivatives", author: "John C. Hull", year: 2021, note: "The standard reference — the book every desk owns." },
      { title: "Stochastic Calculus for Finance I & II", author: "Steven E. Shreve", year: 2004, note: "The mathematics, built carefully from binomial trees to Itô." },
      { title: "The Concepts and Practice of Mathematical Finance", author: "Mark S. Joshi", year: 2008, note: "Theory wired to implementation, by a practitioner." },
      { title: "The Volatility Surface", author: "Jim Gatheral", year: 2006, note: "How implied vol really behaves — and how to model it." },
      { title: "Dynamic Hedging", author: "Nassim Nicholas Taleb", year: 1997, note: "Options as traded, not as taught — Greeks in the wild." },
      { title: "Arbitrage Theory in Continuous Time", author: "Tomas Björk", year: 2009, note: "The clean, rigorous route through no-arbitrage pricing." },
    ],
  },
  {
    ...
    books: [
      { title: "Active Portfolio Management", author: "Richard C. Grinold & Ronald N. Kahn", year: 1999, note: "The quant-equity bible — information ratio, alpha, breadth." },
      { title: "Expected Returns", author: "Antti Ilmanen", year: 2011, note: "A sweeping, evidence-based map of what actually drives returns." },
      { title: "Asset Management: A Systematic Approach to Factor Investing", author: "Andrew Ang", year: 2014, note: "Factors as the underlying assets of everything you own." },
      { title: "Risk and Asset Allocation", author: "Attilio Meucci", year: 2005, note: "A rigorous, estimation-aware treatment of allocation." },
      { title: "Quantitative Equity Portfolio Management", author: "Chincarini & Kim", year: 2006, note: "Building and risk-managing a real quant equity book." },
    ],
  },
  {
    ...
    books: [
      { title: "Quantitative Risk Management: Concepts, Techniques and Tools", author: "McNeil, Frey & Embrechts", year: 2015, note: "The QRM canon — EVT, copulas, coherent risk measures." },
      { title: "Value at Risk", author: "Philippe Jorion", year: 2006, note: "The benchmark text on VaR and its honest limits." },
      { title: "Risk Management and Financial Institutions", author: "John C. Hull", year: 2018, note: "Market, credit, and operational risk for the whole institution." },
      { title: "The Concentration of Risk (Modelling Extremal Events)", author: "Embrechts, Klüppelberg & Mikosch", year: 1997, note: "The deep reference for extreme-value theory in finance." },
    ],
  },
  {
    ...
    books: [
      { title: "Trading and Exchanges", author: "Larry Harris", year: 2003, note: "Market microstructure for practitioners — the definitive plain-English account." },
      { title: "Algorithmic and High-Frequency Trading", author: "Cartea, Jaimungal & Penalva", year: 2015, note: "The mathematics of execution, market-making, and optimal trading." },
      { title: "Market Microstructure Theory", author: "Maureen O'Hara", year: 1995, note: "The foundational theory of information and price formation." },
      { title: "Inside the Black Box", author: "Rishi K. Narang", year: 2013, note: "What a quant trading firm really does, demystified." },
      { title: "Algorithmic Trading", author: "Ernest P. Chan", year: 2013, note: "Mean-reversion and momentum strategies, built and tested." },
    ],
  },
  {
    ...
    books: [
      { title: "Advances in Financial Machine Learning", author: "Marcos López de Prado", year: 2018, note: "The modern playbook — and a relentless guide to not overfitting." },
      { title: "Analysis of Financial Time Series", author: "Ruey S. Tsay", year: 2010, note: "GARCH, regime models, and the econometrics of returns." },
      { title: "The Elements of Statistical Learning", author: "Hastie, Tibshirani & Friedman", year: 2009, note: "The reference for the statistical learning underneath it all." },
      { title: "Machine Learning for Asset Managers", author: "Marcos López de Prado", year: 2020, note: "A short, sharp course on doing ML in finance correctly." },
    ],
  },
  {
    ...
    books: [
      { title: "Python for Finance", author: "Yves Hilpisch", year: 2018, note: "The end-to-end Python quant stack, by example." },
      { title: "Machine Learning for Algorithmic Trading", author: "Stefan Jansen", year: 2020, note: "A practical, code-first pipeline from data to backtest." },
      { title: "Quantitative Trading", author: "Ernest P. Chan", year: 2008, note: "How to build your own algorithmic trading business." },
    ],
  },
];
