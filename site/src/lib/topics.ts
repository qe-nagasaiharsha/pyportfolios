/* ============================================================================
   Topic report cards — Batch 1 (ROADMAP CW31, Bhavya).
   16 topics across the 4 site categories × 4 content formats, specs per
...
export interface TopicCard {
  ...
  assets: string;
  timeframe: string;
  /** Why a practitioner cares — the card's "Use" line. */
  use: string;
...
export const TOPIC_CARDS: TopicCard[] = [
  ...
  },
  {
    ...
    timeframe: "Jan 2018 – Dec 2024 (trailing 1y vol)",
  ...
  },
  {
    ...
    assets: "US Treasuries (2y–30y) + SHY / IEF / TLT (iShares)",
    timeframe: "Static pricing + calendar year 2022",
    use: "Measuring rate risk; duration targeting and the ±100bp stress tests in every risk report.",
  ...
  },
  {
    ...
    timeframe: "2019 – 2024 + recent option chain",
    use: "Pricing options consistently across strikes — the vol desk's answer to the smile BS can't fit.",
    article: "heston-vs-black-scholes",
    lane: "editorial",
  },
  ...
  /* ----------------------------------------- 02 · Portfolio Optimization -- */
  {
    ...
    assets: "SPY · TLT · GLD · VNQ · VEA · VWO",
    timeframe: "Jan 2015 – Dec 2024",
  ...
  },
  {
    ...
    assets: "EWJ · EWG · EWU · EWA · EWC (iShares country ETFs)",
    timeframe: "Jan 2015 – Dec 2024",
    use: "Blending market-implied returns with your own views — stable weights without extreme bets.",
  ...
  },
  {
    ...
    timeframe: "Jan 2010 – Dec 2024",
    use: "Allocating by risk contribution instead of capital — the all-weather portfolio blueprint.",
  ...
  /* --------------------------------------------- 03 · Risk Management -- */
  {
    ...
    assets: "DAX (^GDAXI)",
    timeframe: "Jan 2010 – Dec 2024",
    use: "Daily loss limits and regulatory capital — the industry's standard downside risk number.",
  ...
  },
  {
    ...
    timeframe: "Jan 2007 – Dec 2024 (incl. GFC)",
    use: "Sizing tail risk when the losses beyond VaR are what actually hurt — Basel's chosen measure.",
  ...
  /* ------------------------------------------ 04 · Algorithmic Trading -- */
  {
    ...
    timeframe: "Jan 2015 – Dec 2024",
    use: "The systematic trend-following workhorse — and backtesting discipline 101.",
  ...
  },
  {
    ...
    timeframe: "Jan 2010 – Dec 2024",
    use: "Adaptive hedge ratios for pairs trading — reacting to relationships that drift over time.",
  ...
  },
  {
    ...
    timeframe: "Jan 2005 – Dec 2024",
    use: "Deciding how fast to trade a signal before its edge evaporates — sets turnover & capacity.",
    article: "alpha-decay-momentum",
    lane: "editorial",
  },
];
